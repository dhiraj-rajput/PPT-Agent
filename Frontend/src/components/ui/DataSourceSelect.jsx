...
export default function DataSourceSelect({ value, onChange, includeAll = true, className = "" }) {
  return (
    <div className={`inline-flex items-center space-x-1 p-1 bg-slate-100 dark:bg-slate-800/80 rounded-xl border border-slate-200 dark:border-slate-700/60 ${className}`}>
      {includeAll && (
        <button
          type="button"
