    ...
    <div>
      ...
      <div className="grid grid-cols-1 gap-5 lg:grid-cols-3">
        <Card className="lg:col-span-1">
          <div className="flex items-center gap-2 rounded-xl border border-slate-200 dark:border-navy-700 bg-slate-50 dark:bg-navy-800/60 px-3.5 py-2.5">
            <Search size={16} className="text-slate-400 dark:text-slate-500" />
            <input placeholder="Search a company to research..." className="w-full bg-transparent text-sm outline-none placeholder:text-slate-400 dark:placeholder:text-slate-500" />
          </div>
        ...
        <div className="flex flex-col gap-5 lg:col-span-2">
          <Card>
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-sm font-bold text-navy-900 dark:text-white">AI Research Summary — {selected.name}</h3>
              </div>
          ...
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-3">
            <Card>
              ...
              <p className="mt-2 text-xs text-slate-400 dark:text-slate-500">Growth Signal</p>
              <p className="text-lg font-extrabold text-navy-900 dark:text-white">Strong</p>
            </Card>
            <Card>
              <ShieldCheck size={18} className="text-brand-600" />
              <p className="mt-2 text-xs text-slate-400 dark:text-slate-500">Risk Level</p>
              <p className="text-lg font-extrabold text-navy-900 dark:text-white">Low</p>
            </Card>
            <Card>
              <Target size={18} className="text-amber-600" />
              <p className="mt-2 text-xs text-slate-400 dark:text-slate-500">Opportunity Fit</p>
              <p className="text-lg font-extrabold text-navy-900 dark:text-white">{selected.matchScore}%</p>
            </Card>
          </div>
          ...
          <Card>
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-sm font-bold text-navy-900 dark:text-white">Service Mapping</h3>
            </div>
            <div className="mt-3 flex flex-wrap gap-2">
              {selected.tags.map((t) => (
                <span key={t} className="rounded-full bg-slate-100 dark:bg-navy-800 px-3 py-1.5 text-xs font-medium text-slate-600 dark:text-slate-300">{t}</span>
              ))}
